...
function returnQuestionContentOnly(id)
{
    var res;
    $.ajax({
        url: "../ajax/Question_ajax/GeQuestionContentOnly",
        type:      'POST',
        async: false,
        data: {'question_id': id},		
        success: function(result) {
...
function returnCustQuestionContentOnly(uid)
{
    var res;
    $.ajax({
        url: "../ajax/Question_ajax/GeCustQuestionContentOnly",
        type:      'POST',
        async: false,
...
<?php echo form_open('designtemplates/create'); ?>
    ...
    <div class="row col-md-12">
        ...
        <div class="col-md-6" style="float: left;">
            <div class="col-md-12"><?php include("template_property_box.php");?></div>
            <div class="col-md-12"><?php include("template_panel_box.php");?></div>
        </div>
        <div class="col-md-3" style="float: left;">
            <div class="col-md-12"><?php include("attribute_box.php");?></div>
            <div class="col-md-12"><?php include("new_section_attribute_box.php");?></div>
            <div class="col-md-12"><?php include("section_attribute_box.php");?></div>
        </div>
    </div>
