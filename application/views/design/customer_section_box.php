...
$items = $customersectiondata;
$listsize = count($customersectiondata);
?>

<div class="row">
	
    <div class="panel panel-default">
        <div class="panel-heading" onclick="colapse_details(this)"><h4>Customer Sections</h4></div>
        
        <div class="table-fixedheader"  style="height: 250px;">
            <table id='customerSectionsList' style="width: 100%;" class=" table-striped table-condensed table-bordered table-hover">
            <tbody id="tbodyCustomerSection"  class="connectedSortable ">
                <tr>              
                     <th>SectionName</th>        	      
                </tr>
