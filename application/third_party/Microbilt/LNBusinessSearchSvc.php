...
class IncomeInfo_Type {
  public $Source; // string
  public $MonthlyIncome; // CurrencyAmount
  public $PmtFreq; // string
  public $PayPerPeriod; // CurrencyAmount
  public $DirectDepositInd; // Boolean
  public $DtOfNextPaycheck; // date
  public $DtOfSecondPaycheck; // date
  public $GrossIncome; // CurrencyAmount
}
...
class AvailableProducts_Type {
  public $ServiceSpeed; // long
  public $DaysFrom; // long
  public $DaysTo; // long
  public $OrderID; // string
  public $MimeType; // string
}

class AcctAttributeInfo_Type {
  public $AttribName; // string
  public $AttribAmt; // CurrencyAmount
  public $AttribDt; // date
}

class Shareholders_Type {
}

class BankVerification_Type {
  public $ABANum; // string
  public $AccountNum; // string
  public $AcctStatus; // string
  public $AcctTimesSeen; // string
  public $DtFirstSeen; // date
  public $DtLastSeen; // date
  public $NACHACode; // string
  public $NACHACodeDt; // date
  public $SourceType; // string
  public $TransType; // string
  public $ACHStatus; // string
  public $BankInfo; // OrgInfo_Type
  public $RoutingNumType; // string
  public $RoutingNumStatus; // string
  public $InstitutionStatusCode; // CodeDescription_Type
  public $InstitutionType; // CodeDescription_Type
  public $ServicingNum; // string
  public $BranchType; // string
  public $RiskLevel; // CodeDescription_Type
  public $PossibleNonDDAAcct; // string
  public $BankPerformanceScore; // string
  public $LRI; // string
  public $LDD; // string
  public $AdditionalABAs; // AdditionalABAs_Type
}
...
class AdditionalABAs_Type {
  public $ABANum; // string
}

class LeadSource_Type {
  public $Name; // string
  public $URL; // string
  public $IPAddress; // string
  public $CostPerLead; // CurrencyAmount
}

class EmailInfo_Type {
  public $EmailAddr; // string
  public $IPAddress; // string
  public $ReportedDt; // date
  public $ValidationCd; // string
}

class RetailItems_Type {
  public $RetailItemSummary; // RetailItemSummary_Type
  public $RetailItemDetail; // RetailItemDetail_Type
}

class RetailItemSummary_Type {
  public $NumOpenItemsPast30Days; // string
  public $NumOpenItemsPast60Days; // string
  public $NumOpenItemsPast90Days; // string
  public $NumOpenItemsPast180Days; // string
  public $NumOpenItemsPast1Yr; // string
  public $NumOpenItemsPast2Yrs; // string
  public $NumOpenItemsPast3Yrs; // string
  public $AmtOpenItemsPast30Days; // CurrencyAmount
  public $AmtOpenItemsPast60Days; // CurrencyAmount
  public $AmtOpenItemsPast90Days; // CurrencyAmount
  public $AmtOpenItemsPast180Days; // CurrencyAmount
  public $AmtOpenItemsPast1Yr; // CurrencyAmount
  public $AmtOpenItemsPast2Yrs; // CurrencyAmount
  public $AmtOpenItemsPast3Yrs; // CurrencyAmount
  public $NumPaidItemsPast30Days; // string
  public $NumPaidItemsPast60Days; // string
  public $NumPaidItemsPast90Days; // string
  public $NumPaidItemsPast180Days; // string
  public $NumPaidItemsPast1Yr; // string
  public $NumPaidItemsPast2Yrs; // string
  public $NumPaidItemsPast3Yrs; // string
  public $AmtPaidItemsPast30Days; // CurrencyAmount
  public $AmtPaidItemsPast60Days; // CurrencyAmount
  public $AmtPaidItemsPast90Days; // CurrencyAmount
  public $AmtPaidItemsPast180Days; // CurrencyAmount
  public $AmtPaidItemsPast1Yr; // CurrencyAmount
  public $AmtPaidItemsPast2Yrs; // CurrencyAmount
  public $AmtPaidItemsPast3Yrs; // CurrencyAmount
  public $MaxAmtOpenItemLargestNSF; // CurrencyAmount
  public $MaxAmtPaidItemLargestNSF; // CurrencyAmount
  public $MinChkNumOpenItem; // string
  public $MinChkNumPaidItem; // string
  public $MinNumDaysToPay; // string
  public $MaxNumDaysToPay; // string
  public $EpisodeSpanAllItems; // string
  public $DaysSinceMostRecentOpenItem; // string
  public $DaysSinceMostRecentPaidItem; // string
  public $NumOpenItemsPast5Yrs; // string
  public $AmtOpenItemsPast5Yrs; // CurrencyAmount
  public $NumPaidItemsPast5Yrs; // string
  public $AmtPaidItemsPast5Yrs; // CurrencyAmount
  public $NumPositiveItemsPast30Days; // string
  public $NumPositiveItemsPast60Days; // string
  public $NumPositiveItemsPast90Days; // string
  public $NumPositiveItemsPast180Days; // string
  public $NumPositiveItemsPast1Yr; // string
  public $NumPositiveItemsPast2Yrs; // string
  public $NumPositiveItemsPast3Yrs; // string
  public $NumPositiveItemsPast5Yrs; // string
  public $AmtPositiveItemsPast30Days; // CurrencyAmount
  public $AmtPositiveItemsPast60Days; // CurrencyAmount
  public $AmtPositiveItemsPast90Days; // CurrencyAmount
  public $AmtPositiveItemsPast180Days; // CurrencyAmount
  public $AmtPositiveItemsPast1Yr; // CurrencyAmount
  public $AmtPositiveItemsPast2Yrs; // CurrencyAmount
  public $AmtPositiveItemsPast3Yrs; // CurrencyAmount
  public $AmtPositiveItemsPast5Yrs; // CurrencyAmount
  public $NumNegativeItemsPast30Days; // string
  public $NumNegativeItemsPast60Days; // string
  public $NumNegativeItemsPast90Days; // string
  public $NumNegativeItemsPast180Days; // string
  public $NumNegativeItemsPast1Yr; // string
  public $NumNegativeItemsPast2Yrs; // string
  public $NumNegativeItemsPast3Yrs; // string
  public $NumNegativeItemsPast5Yrs; // string
  public $AmtNegativeItemsPast30Days; // CurrencyAmount
  public $AmtNegativeItemsPast60Days; // CurrencyAmount
  public $AmtNegativeItemsPast90Days; // CurrencyAmount
  public $AmtNegativeItemsPast180Days; // CurrencyAmount
  public $AmtNegativeItemsPast1Yr; // CurrencyAmount
  public $AmtNegativeItemsPast2Yrs; // CurrencyAmount
  public $AmtNegativeItemsPast3Yrs; // CurrencyAmount
  public $AmtNegativeItemsPast5Yrs; // CurrencyAmount
  public $NumNegativePaidItemsPast30Days; // string
  public $NumNegativePaidItemsPast60Days; // string
  public $NumNegativePaidItemsPast90Days; // string
  public $NumNegativePaidItemsPast180Days; // string
  public $NumNegativePaidItemsPast1Yr; // string
  public $NumNegativePaidItemsPast2Yrs; // string
  public $NumNegativePaidItemsPast3Yrs; // string
  public $NumNegativePaidItemsPast5Yrs; // string
  public $AmtNegativePaidItemsPast30Days; // CurrencyAmount
  public $AmtNegativePaidItemsPast60Days; // CurrencyAmount
  public $AmtNegativePaidItemsPast90Days; // CurrencyAmount
  public $AmtNegativePaidItemsPast180Days; // CurrencyAmount
  public $AmtNegativePaidItemsPast1Yr; // CurrencyAmount
  public $AmtNegativePaidItemsPast2Yrs; // CurrencyAmount
  public $AmtNegativePaidItemsPast3Yrs; // CurrencyAmount
  public $AmtNegativePaidItemsPast5Yrs; // CurrencyAmount
  public $NumNegativeOpenItemsPast30Days; // string
  public $NumNegativeOpenItemsPast60Days; // string
  public $NumNegativeOpenItemsPast90Days; // string
  public $NumNegativeOpenItemsPast180Days; // string
  public $NumNegativeOpenItemsPast1Yr; // string
  public $NumNegativeOpenItemsPast2Yrs; // string
  public $NumNegativeOpenItemsPast3Yrs; // string
  public $NumNegativeOpenItemsPast5Yrs; // string
  public $AmtNegativeOpenItemsPast30Days; // CurrencyAmount
  public $AmtNegativeOpenItemsPast60Days; // CurrencyAmount
  public $AmtNegativeOpenItemsPast90Days; // CurrencyAmount
  public $AmtNegativeOpenItemsPast180Days; // CurrencyAmount
  public $AmtNegativeOpenItemsPast1Yr; // CurrencyAmount
  public $AmtNegativeOpenItemsPast2Yrs; // CurrencyAmount
  public $AmtNegativeOpenItemsPast3Yrs; // CurrencyAmount
  public $AmtNegativeOpenItemsPast5Yrs; // CurrencyAmount
  public $NumAssociatedABAsPast30Days; // string
  public $NumAssociatedABAsPast60Days; // string
  public $NumAssociatedABAsPast90Days; // string
  public $NumAssociatedABAsPast180Days; // string
  public $NumAssociatedABAsPast1Yr; // string
  public $NumAssociatedABAsPast2Yrs; // string
  public $NumAssociatedABAsPast3Yrs; // string
  public $NumAssociatedABAsPast5Yrs; // string
  public $NumAssociatedMICRsPast30Days; // string
  public $NumAssociatedMICRsPast60Days; // string
  public $NumAssociatedMICRsPast90Days; // string
  public $NumAssociatedMICRsPast180Days; // string
  public $NumAssociatedMICRsPast1Yr; // string
  public $NumAssociatedMICRsPast2Yrs; // string
  public $NumAssociatedMICRsPast3Yrs; // string
  public $NumAssociatedMICRsPast5Yrs; // string
  public $NumClosedMICRsPast30Days; // string
  public $NumClosedMICRsPast60Days; // string
  public $NumClosedMICRsPast90Days; // string
  public $NumClosedMICRsPast180Days; // string
  public $NumClosedMICRsPast1Yr; // string
  public $NumClosedMICRsPast2Yrs; // string
  public $NumClosedMICRsPast3Yrs; // string
  public $NumClosedMICRsPast5Yrs; // string
  public $InquiriesPast30Days; // string
  public $InquiriesPast60Days; // string
  public $InquiriesPast90Days; // string
  public $InquiriesPast180Days; // string
  public $InquiriesPast1Yr; // string
  public $InquiriesPast2Yrs; // string
  public $InquiriesPast3Yrs; // string
  public $InquiriesPast5Yrs; // string
  public $MinItemAmt; // CurrencyAmount
  public $MaxItemAmt; // CurrencyAmount
  public $MinPositiveItemAmt; // CurrencyAmount
  public $MaxPositiveItemAmt; // CurrencyAmount
  public $MinNegativeItemAmt; // CurrencyAmount
  public $MaxNegativeItemAmt; // CurrencyAmount
}

class RetailItemDetail_Type {
  public $ABANum; // string
  public $AccountNum; // string
  ...
  public $CheckAmt; // CurrencyAmount
  public $PaidDt; // date
  public $TransStatus; // CodeDescription_Type
  public $InstitutionName; // string
  public $PosOrNegInd; // string
}
...
class AccountClosures_Type {
  public $AccountClosureSummary; // AccountClosureSummary_Type
  public $AccountClosureDetail; // AccountClosureDetail_Type
}

class AccountClosureSummary_Type {
  public $NumClosuresPast30Days; // string
  public $NumClosuresPast60Days; // string
  public $NumClosuresPast90Days; // string
  public $NumClosuresPast180Days; // string
  public $NumClosuresPast1Yr; // string
  public $NumClosuresPast2Yrs; // string
  public $NumClosuresPast3Yrs; // string
  public $NumClosuresPast5Yrs; // string
  public $FraudClosureQty; // string
  public $DaysSinceMostRecentClosure; // string
  public $DaysSinceFirstClosure; // string
  public $AvgDaysBetweenClosures; // string
  public $CountClosureRptsDisputed; // string
  public $CountClosureRptsDisputedButResolved; // string
}

class AccountClosureDetail_Type {
  public $ABANum; // string
  public $AccountNum; // string
  ...
  public $ClosureAmt; // CurrencyAmount
  public $PaidDt; // date
  public $ConsumerDispute; // ConsumerStatement_Type
}
...
class Summary_Type {
  ...
  public $OtherAmounts; // OtherAmounts_Type
  public $OtherPercentages; // OtherPercentages_Type
}
...
class OtherAmounts_Type {
  public $AmtType; // string
  public $OtherAmt; // CurrencyAmount
}

class OtherPercentages_Type {
  public $PercentageType; // string
  public $OtherPercentage; // decimal
}
...
class Liability_Type {
  ...
  public $BalanceAmt; // CompAmt_Type
  public $DtFirstDelinq; // date
  public $MemberNumId; // string
  public $PrevMemberNumId; // string
  public $PrevAcctNum; // string
  public $FreezeFlag; // CodeDescription_Type
  public $PrincipalAmt; // CurrencyAmount
  public $InterestAmt; // CurrencyAmount
  public $AccountHistory; // AccountHistory_Type
}
...
class AccountHistory_Type {
  public $DtEffective; // date
  public $BalanceAmt; // CompAmt_Type
  public $HighCreditAmt; // CompAmt_Type
  public $CreditLimitAmt; // CurrencyAmount
  public $ScheduledPmtAmt; // CurrencyAmount
...
class PersonInfo_Type {
  ...
  public $OwnershipPercentage; // decimal
}
...
class EmploymentHistory_Type {
  ...
  public $Message; // Message_Type
  public $SourceType; // string
  public $DisconnectInd; // string
  public $FirstRptdDt; // date
  public $LastRptdDt; // date
...
class BankAccount_Type {
  ...
  public $CreditCardInfo; // CreditCardInfo_Type
}
...
class LNBusinessSearchRq_Type {
  public $MsgRqHdr; // MsgRqHdr_Type
  public $OrgInfo; // OrgInfo_Type
  public $PersonInfo; // PersonInfo_Type
}

class LNBusinessSearchRs_Type {
...
class Subject {
  ...
  public $Verified; // Boolean
  public $LastActivityDt; // date
  public $HighRiskInd; // Message_Type
  public $DataIndicators; // DataIndicators_Type
}

class GetReport {
  public $inquiry; // LNBusinessSearchRq_Type
}

class GetReportResponse {
  public $GetReportResult; // LNBusinessSearchRs_Type
}
...
class GetArchiveReportResponse {
  public $GetArchiveReportResult; // LNBusinessSearchRs_Type
}
...
class MapResponse {
  public $MapResult; // LNBusinessSearchRs_Type
}


/**
 * LNBusinessSearchSvc class
 *
 *
 *
 * @author    {author}
 ...
 * @package   {package}
 */
class LNBusinessSearchSvc extends SoapClient {
  ...
  private static $classmap = array(
                                    ...
                                    'Aggregate' => 'Aggregate',
                                    'IncomeInfo_Type' => 'IncomeInfo_Type',
                                    'CurrencyAmount' => 'CurrencyAmount',
                                    'Boolean' => 'Boolean',
                                    'AvailableProducts_Type' => 'AvailableProducts_Type',
                                    'AcctAttributeInfo_Type' => 'AcctAttributeInfo_Type',
                                    'Shareholders_Type' => 'Shareholders_Type',
                                    'BankVerification_Type' => 'BankVerification_Type',
                                    'CodeDescription_Type' => 'CodeDescription_Type',
                                    'AdditionalABAs_Type' => 'AdditionalABAs_Type',
                                    'LeadSource_Type' => 'LeadSource_Type',
                                    'EmailInfo_Type' => 'EmailInfo_Type',
                                    'RetailItems_Type' => 'RetailItems_Type',
                                    'RetailItemSummary_Type' => 'RetailItemSummary_Type',
                                    'RetailItemDetail_Type' => 'RetailItemDetail_Type',
                                    'DriversLicense_Type' => 'DriversLicense_Type',
                                    'Option_Type' => 'Option_Type',
                                    'Message_Type' => 'Message_Type',
                                    'AccountClosures_Type' => 'AccountClosures_Type',
                                    'AccountClosureSummary_Type' => 'AccountClosureSummary_Type',
                                    'AccountClosureDetail_Type' => 'AccountClosureDetail_Type',
                                    'ConsumerStatement_Type' => 'ConsumerStatement_Type',
                                    'Summary_Type' => 'Summary_Type',
                                    'CompAmt_Type' => 'CompAmt_Type',
                                    'OtherAmounts_Type' => 'OtherAmounts_Type',
                                    'OtherPercentages_Type' => 'OtherPercentages_Type',
                                    ...
                                    'AccountHistory_Type' => 'AccountHistory_Type',
                                    ...
                                    'LNBusinessSearchRq_Type' => 'LNBusinessSearchRq_Type',
                                    'LNBusinessSearchRs_Type' => 'LNBusinessSearchRs_Type',
                                    'Subject' => 'Subject',
                                    'GetReport' => 'GetReport',
  ...
  public function LNBusinessSearchSvc($wsdl = "https://creditserver.microbilt.com/WebServices/Seisint/LNBusinessSearch.svc?wsdl", $options = array()) {
