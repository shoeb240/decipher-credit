...
<div class="input">
<textarea   id="SubmitFields[<?php echo $field->DomId; ?>][Textarea]" <?php echo isNullOrEmpty($field->Hint) ? "" : "placeholder='" . $field->Hint ."'"  ; ?> name="SubmitFields[<?php echo $field->DomId; ?>][Textarea]"  type="text" maxlength="<?php echo $field->MaxCharacters; ?>" cols="<?php echo $field->Columns; ?>" rows="<?php echo $field->Rows; ?>"><?php echo getFormFieldValue($field); ?></textarea>
<?php
     if ($field->isEditMode())
     {
