...
<html lang="en">
	...
	?>
		...
		<script type="text/javascript" src="<?php echo $docRoot; ?>/scripts/jquery.tmpl.min.js"></script>
        ...
        <script type="text/javascript" src="<?php echo $docRoot; ?>/scripts/jquery.simplemodal.1.4.min.js"></script>
        ...
        <link type="text/css" href="<?php echo $docRoot; ?>/content/themes/base/jquery.ui.selectable.css" rel="stylesheet"  />
        <link type="text/css" href="<?php echo $docRoot; ?>/content/themes/base/jquery.ui.autocomplete.css" rel="stylesheet"  />
        <link type="text/css" href="<?php echo $docRoot; ?>/content/themes/base/jquery.ui.slider.css" rel="stylesheet"  />
		...
		<link type="text/css" href="<?php echo $docRoot; ?>/content/css/form-builder/forms-modal.css" rel="stylesheet"  />          
		<link type="text/css" href="<?php echo $docRoot; ?>/content/css/form-builder/select.css" rel="stylesheet"  />          
        <?php
