...
class Constants
{
	const FORM_DEFAULT_TITLE="New Registration Form";
   
	const FORM_DEFAULT_SUBMIT_BUTTON_TEXT="Submit";
   
	const FORM_DEFAULT_CONFIRMATION_MESSAGE="Thank you for signing up";
	...
	const COUNTRIES_ARRAY = array("AF" => "Afghanistan",
								  "AX" => "Åland Islands",
								  "AL" => "Albania",
								  "DZ" => "Algeria",
								  "AS" => "American Samoa",
