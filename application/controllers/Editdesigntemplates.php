...
class EditDesignTemplates extends Base {
	...
	private $customer_id;
        ...
        public function view($slug = NULL)
        {
                ...
                $data['templates'] =  $this->customertemplates_model->get_customertemplates($this->customer_id);
                $this->load->view('editdesign/design_templateview.php', $data);
        }
    ...
    public function create() 
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            $this->load->view('editdesign/design_templatecreate',$data);
        } else {
    ...
    public function edit($template_id)
    {
        ...
        if ($this->form_validation->run() === FALSE)
        {
            ...
            $this->load->view('editdesign/design_templateedit',$data);
        }
        else 
        {
